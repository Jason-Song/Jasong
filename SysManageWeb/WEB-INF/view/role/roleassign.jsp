		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">用户:<span id="sfId"></span>的角色</h3>
				...
				<div class="panel-body">
					...
					<table class="table table-bordered table-striped" id="listtable" style="width:100%">
						<thead>
							<tr>
								<th>角色id</th>
								<th>角色名称</th>
...
$(function () {
	...
	$('#bupdate').click( function () {
		...
		if (rowsObj[0]) {
			...
			WebUtils.ajaxSubmitJson('roleassign/save/${staffId}',JSON.stringify(changed),function(result) {
				alert (result.msg);
				table.draw();
			});
		}
