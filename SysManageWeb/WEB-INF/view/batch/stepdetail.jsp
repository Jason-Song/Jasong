...
<table class='s1-params' >
	...
	<tr>
		...
		<td colspan="3"><n:select name="procClass" id="procClass" list='batchProcesses' listKey="value" listValue="value" validate='{required:true}' value='step.procClass'></n:select>
		</td>
	</tr>
	<tr>
