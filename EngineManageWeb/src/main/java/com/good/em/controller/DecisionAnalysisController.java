...
public class DecisionAnalysisController {
    private static Logger logger = LoggerFactory.getLogger(DecisionAnalysisController.class);
    ...
    public String toPage() throws Exception {
        return "/decisionTree/modelAnalysis";
    }
	...
	public WebPageResult getSelectData(){
		...
		WebPageResult ret =null;
		try {
			dataList = modelAnalysisService.getSelectData("3");
			ret = new WebPageResult(dataList);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(MsgConstants.E0000, e);
