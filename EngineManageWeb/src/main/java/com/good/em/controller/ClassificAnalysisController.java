...
public class ClassificAnalysisController {
    private static Logger logger = LoggerFactory.getLogger(ClassificAnalysisController.class);
    ...
    public String toPage() throws Exception {
        return "/classification/modelAnalysis";
    }
	...
	public WebPageResult getSelectData(){
		...
		WebPageResult ret =null;
		try {
			dataList = modelAnalysisService.getSelectData("2");
			ret = new WebPageResult(dataList);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(MsgConstants.E0000, e);
