...
public class LRModelAnalysisController {
    private static Logger logger = LoggerFactory.getLogger(LRModelAnalysisController.class);
    ...
    public String toPage() throws Exception {
        return "/logisticRegression/modelAnalysis";
    }
	...
	public WebPageResult getSelectData(){
		...
		WebPageResult ret =null;
		try {
			dataList = modelAnalysisService.getSelectData("5");
			ret = new WebPageResult(dataList);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(MsgConstants.E0000, e);
