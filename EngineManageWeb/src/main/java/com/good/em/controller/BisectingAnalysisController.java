...
public class BisectingAnalysisController {
    private static Logger logger = LoggerFactory.getLogger(BisectingAnalysisController.class);
    ...
    public String toPage() throws Exception {
        return "/bisecting/modelAnalysis";
    }
	...
	public WebPageResult getSelectData(){
		...
		WebPageResult ret =null;
		try {
			dataList = modelAnalysisService.getSelectData("8");
			ret = new WebPageResult(dataList);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(MsgConstants.E0000, e);
