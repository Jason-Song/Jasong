	...
	<div class="page-container">
		<div class="main-content">
			<div class="page-title">
				<div class="title-env">
					<h1 class="title">随机森林模型分析</h1>
					<p class="description">根据随机森林引擎反馈的模型指标，对训练模型进行分析</p>
				</div>
			</div>
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-4">
							...
							<input class="form-control" readonly="readonly" id="s_condIds" name="s_condIds" value=<c:if test="${not empty fileId}">${requestScope.fileId}</c:if> />
						</div>
						<div class="col-md-4">
							<label class="control-label">模型序列号</label>
							<select class="form-control" id="s_modelId" ></select>
						</div>
						<div class="col-md-4">
