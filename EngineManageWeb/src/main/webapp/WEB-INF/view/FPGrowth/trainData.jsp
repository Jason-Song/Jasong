	...
	<div class="page-container">
		<div class="main-content">
			<div class="page-title">
				<div class="title-env">
					<h1 class="title">FPGrowth引擎训练数据</h1>
					<p class="description">按照模板格式上传训练数据，可进行FPGrowth模型训练</p>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
				                    ...
				                    <input name="minSupport" id="minSupport" style='width:100%' data-validate="required"></input>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">最小置信度</label>
				                    <input name="minConfidence" id="minConfidence" style='width:100%' data-validate="required"></input>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">数据分区数</label>
				                    <input name="numPartitions" id="numPartitions" style='width:100%' data-validate="required"></input>
								</div>
							</div>
						</div>
						<div class="row">
		...
		$('#trainbutton').click( function () {
			...
			if(data){
				$("#traindetail").on("shown.bs.modal",function(){
					...
					$("input[name='minSupport']").val("0.2");
					$("input[name='minConfidence']").val("0.8");
					$("input[name='numPartitions']").val("10");
