...
alter table LYODSVW.T_SCENE ADD SHORT_ROW VARCHAR2(1000);
alter table LYODSVW.T_SCENE ADD ROW_NAME VARCHAR2(1000);
alter table LYODSVW.T_SCENE ADD COLUMN_NAME VARCHAR2(1000);
alter table LYODSVW.T_KMEANS_RESULT ADD PREDICT_ID NUMBER default 0 not null;
--添加平均中心距离
alter table LYODSVW.T_KMEANS_INDEX ADD DISTANCE_MEAN VARCHAR2(1000);
alter table LYODSVW.T_KMEANS_RESULT ADD DISTANCE_MEAN VARCHAR2(1000);
