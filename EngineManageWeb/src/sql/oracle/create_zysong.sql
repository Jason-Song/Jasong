...
COMMENT ON COLUMN LYODSVW.T_KMEANS_INDEX.WSSSE IS '集合内误差平方和';
COMMENT ON COLUMN LYODSVW.T_KMEANS_INDEX.DISTANCE_MEAN IS '平均中心距离';
...
COMMENT ON COLUMN LYODSVW.T_KMEANS_RESULT.DISTANCE_MEAN IS '平均中心距离';
