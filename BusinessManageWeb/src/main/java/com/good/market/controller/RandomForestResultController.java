...
public class RandomForestResultController {
    private static Logger logger = LoggerFactory.getLogger(RandomForestResultController.class);
  
    @Autowired
    private KMeansResultService kMeansResultService;
    
    @RequestMapping(value = "/randomForestResult", method = { RequestMethod.GET})
    public String toPage() throws Exception {
        return "/rule/randomForestResult";
    }
    
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/randomForestList", method = { RequestMethod.POST,
			RequestMethod.GET })
	@ResponseBody
	public WebPageResult randomForestList(WebRequest wr, HttpServletRequest request)
			throws Exception {
		// 获取排序信息
