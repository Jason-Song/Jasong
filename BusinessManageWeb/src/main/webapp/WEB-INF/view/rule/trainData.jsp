...
<div class="modal fade" id="detail">
   <div class="modal-dialog" >
				...
				<div id="parent">
					<div class="modal-body">
						<div class="row" >
							<div class="col-md-12">
								<div class="form-group">
									<label for="scriptName" class="control-label">部门</label>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="form-control" id="fileEncoding" name="fileEncoding" data-validate="required" data-message-required="此项必须输入." >
	...
	$(function(){
		...
		$('#addbutton').click( function () {
			$('#detail').modal('show', {backdrop: 'static',action: "trainDataAdd",title:"新增训练数据"});
		});
   ...
   //附件上传
    function uploadFile() {
    	...
    	var encodingObj = document.getElementById("fileEncoding"); // 获取文件对象
    	var fmtObj = document.getElementById("fmtFileName"); // 获取文件对象
    	oData.append("file", fileObj);  
    	oData.append("unit", unitObj.value);  
    	oData.append("fileEncoding", encodingObj.value);  
    	oData.append("fmtFileName", fmtObj.value);  
